...
public class BDVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BDVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BDVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BDVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BDVDateTimeConverter dateTimeConverter = new BDVStandardDateTimeConverter();

    public BDVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BDVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BDVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BDVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BDVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BDVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
