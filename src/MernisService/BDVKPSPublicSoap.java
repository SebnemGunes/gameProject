...
public class BDVKPSPublicSoap
{
    ...
    public BDVKPSPublicSoap(){}

    public BDVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BDVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BDVExtendedSoapSerializationEnvelope envelope= new BDVExtendedSoapSerializationEnvelope(BDVExtendedSoapSerializationEnvelope.VER11);
